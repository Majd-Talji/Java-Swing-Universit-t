 ...
 * @author Majd
 */
public class AnzeigenKurse extends javax.swing.JFrame {
...
//                setBackground(Color.getHSBColor(0, 204, 204));
    ...
    private void tableDatabase() {
        ...
        try {
            ...
            while (rst.next()) {
                ...
                model.addRow(new Object[]{rst.getString("id_course"), rst.getString("name_course"), rst.getFloat("hour"), rst.getFloat("salary_one_hour"), rst.getString("name_doctor"), rst.getInt("semester")});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Kursnummer", "Kursname", "Anzahl Stunden", "Kosten Stunde", "Kurs Doctor", "Semester"
            }
        ) {
        ...
        setSize(new java.awt.Dimension(1070, 485));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnzeigenKurse.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
